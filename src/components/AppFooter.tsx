        ...
        <div className="space-y-6">
          ...
          >
            <div className="flex items-center gap-1.5 mb-1">
              <p className="text-sm font-black text-slate-900 dark:text-white uppercase italic tracking-tight pr-1">
                {developerNode.name}
              </p>
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0 pointer-events-none ml-[10px]">
            ...
            <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Institutional Node Lead</p>
