        ...
        <div className="space-y-6">
          ...
          >
            <div className="flex items-center mb-1">
              ...
              {/* Institutional Verified Authority Badge - Scaled and Positioned */}
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0 pointer-events-none ml-2">
