...
export function AppSidebar() {
  ...
  return (
    <aside className={cn(
      ...
      <div className={cn(
        "h-24 flex items-center border-b border-slate-50 dark:border-slate-900 transition-all px-2 md:px-4"
      )}>
        <div className={cn(
          ...
          <div className="flex items-center gap-2 overflow-hidden">
            <div className={cn(
              ...
              <ZorvynLogo className={cn("text-white transition-all", isOpen ? "w-4 h-4" : "w-4 h-4")} />
            </div>
            {isOpen && (
