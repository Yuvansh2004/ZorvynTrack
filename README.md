...
- **The Result**: Once that timer expires, the entry becomes **Permanent Telemetry**. It can no longer be edited or deleted by a Viewer node, ensuring that the student's audit trail remains untampered and reliable for the college office. This prevents "historical revisionism" in student spending data.
...
- **The Solution**: I implemented **Adaptive Typography** and horizontal-scrolling Summary Cards. This ensures that even with **50-100 transactions** on the screen, the numbers never overlap or become unreadable. The sidebar is also retractable to maximize data horizontal space.
