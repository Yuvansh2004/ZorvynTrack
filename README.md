...
## 🏛️ 1. Project Vision: The "Institutional" Terminal
ZorvynTrack is not a typical consumer "banking app." It is designed as an **Institutional Node Terminal**. The goal was to create a professional auditing tool that feels like a bank’s global ledger or a college finance office terminal. 

Every design choice—from the **Slate** color palette to the **Permanent Telemetry** logic—is built to signal **Trust, Accuracy, and Authority.**
...
* **Library:** **React 19**
* **Styling:** **Tailwind CSS** (Custom Institutional Theme)
* **State Management:** **React Context API** (Acts as the "Central Telemetry Hub" for real-time synchronization across charts and tables).
* **Data Visualization:** **Recharts** (For Transaction Velocity and Sector Analysis).
* **Icons:** **Lucide-React**
